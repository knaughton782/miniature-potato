...
format js date, use toDateString() method

functional componenets are just functions that return a (react) element

spread operator = split up array elements or object properties, all elements
rest operator = merge a list of function arguments into an array
destructuring = extract single array elements and story them as variables
...
Fullscreen
Default view
Go to Previous lecture22. Next-Gen JavaScript - Summary
Go to Next lecture24. Module Introduction
